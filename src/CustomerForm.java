...
//System.out.println("Entered text is " + User_Name_TextField.getText());
	...
	if( !(First_Password_TextField.equals(Second_Password_Label))&&(First_Password_TextField.getLength()<6)) {
		Stage pop_up = new Stage();
	...
	System.out.println("it worked, fill in the data base!");	//then write to the database from all text fields
	Counter_To_Check_If_All_Fields_Are_Valid=0;
	System.exit(0);
	}
